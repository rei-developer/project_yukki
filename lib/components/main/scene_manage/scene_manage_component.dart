...
class _SceneManageComponentState extends ConsumerState<SceneManageComponent> {
  ...
  void _toggleLock() {
    ...
    setCursor(isLocked ? SystemMouseCursors.basic : SystemMouseCursors.grab);
  }
  ...
  void setCursor([
    ...
    bool isToBasicCursor = false,
  ]) {
    if (isToBasicCursor) {
      nextCursor = SystemMouseCursors.basic;
    }
        ...
        ...contents
            .map(
              (e) => Draggable(
                ...
                data: e,
                childWhenDragging: _renderSceneContent(e, isRoot, true),
                onDragStarted: () => setCursor(
              ...
              DragTarget(
                ...
                builder: (context, _, __) => Row(
                  children: [
                    ...
                    Expanded(
                        child: Text('테스트입니다', style: TextStyle(color: color))),
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 5),
                  Expanded(child: Text(t.scene.add)),
